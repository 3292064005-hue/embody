...
const runtimeText = computed(() => deriveRuntimeText(readinessStore.runtimeHealthy, readinessStore.simulated, readinessStore.runtimeMissingChecks, readinessStore.authorityState, readinessStore.taskExecutionState));
const modeText = computed(() => deriveModeText(readinessStore.modeReady, readinessStore.failingChecks, readinessStore.taskExecutionState));
