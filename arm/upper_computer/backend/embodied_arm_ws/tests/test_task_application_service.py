...
def _build_service() -> TaskApplicationService:
    ...
    return TaskApplicationService(orchestrator, PlanningAdapter(planner, executor), ExecutionAdapter(), verification, FaultManager(), profile, allow_legacy_in_process_planning=True)
