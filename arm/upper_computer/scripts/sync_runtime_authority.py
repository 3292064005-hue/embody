...
from runtime_authority import (
    ...
    derived_runtime_authority_sections,
...
def _render_outputs() -> dict[Path, str]:
    ...
    for section_path, payload in derived_runtime_authority_sections(authority).items():
        outputs[section_path] = render_yaml_with_header(payload, header=HEADER)
    return outputs
