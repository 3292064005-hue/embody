...
def test_backend_readiness_snapshot_remains_authoritative_over_local_recomputation():
    ...
    state.set_hardware({'joints': [0, 0, 0, 0, 0, 0], 'gripperOpen': True, 'homed': True, 'limits': [False] * 6, 'poseName': '', 'busy': False, 'errorCode': None, 'sourceStm32Online': True, 'sourceEsp32Online': True, 'rawStatus': {}, 'lastFrameAt': None})
