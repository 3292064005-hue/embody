...
class StartTaskDecisionResponse(BaseModel):
    ...
    templateVersion: int
    pluginContractVersion: int
    success: bool = True
    accepted: bool = True
    authoritativeStatus: Literal['accepted', 'success', 'failed', 'blocked', 'rejected', 'observed'] | str = 'accepted'
    completionPending: bool = True
    localPreviewOnly: bool = False
