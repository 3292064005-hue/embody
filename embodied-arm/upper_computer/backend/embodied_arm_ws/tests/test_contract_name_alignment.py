...
def test_generated_interface_index_includes_camera_ingress_topics() -> None:
    assert '/arm/camera/image_raw' in INDEX
    assert '/arm/camera/image_raw_compat' in INDEX
    assert '/arm/camera/camera_info' in INDEX
