...
from arm_esp32_gateway import Esp32GatewayNode, VoiceEventClient, BoardHealthParser
...
def test_new_split_stack_packages_import_and_basic_behaviors():
    assert CameraDriverNode().capture_once()['width'] == 640
    ...
    assert PerceptionNode().process([[0]]) == []
