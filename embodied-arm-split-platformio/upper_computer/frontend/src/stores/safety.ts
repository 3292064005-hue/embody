...
import { createSafetySnapshot, evaluateGripper, evaluateHome, evaluateJog, evaluateResetFault, evaluateStartTask, evaluateStopTask, summarizeSafetySnapshot } from '@/domain/safety/guards';
...
export const useSafetyStore = defineStore('safety', () => {
  ...
  return { snapshot, guardSummary, canStartTask, canStopTask, canJog, canControlGripper, canResetFault, canHomeRobot };
});
